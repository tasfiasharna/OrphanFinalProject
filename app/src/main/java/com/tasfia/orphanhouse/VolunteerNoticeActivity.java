...
public class VolunteerNoticeActivity extends AppCompatActivity {
    ...
    String url = "http://192.168.0.105:8080/api/allnotice/admin";
    Notices notices;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_volunteer_notice);
    ...
    public void retrieveData () {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url,
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(VolunteerNoticeActivity.this, "No Internet Connection  !!!", Toast.LENGTH_LONG).show();
            }
        });
    ...
    public void onBackPressed() {
        if (back_pressed + TIME_DELAY > System.currentTimeMillis()) {
            ...
            Intent intent=new Intent(VolunteerNoticeActivity.this, VolunteerProfileActivity.class);
