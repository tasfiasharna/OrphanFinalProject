...
public class PermanentDonatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_permanent_donator);
        ...
        btn_registration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(PermanentDonatorActivity.this);
...
//            loading.setTitle("Data Inserted");
            ...
            loading.show();
            StringRequest request = new StringRequest(Request.Method.POST,"http://192.168.0.105:8080/api/dreg/permanentuser/android/post/"+email+"/"+phone+"/"+name+"/"+gender+"/"+address+"/"+city+"/"+profession,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.equals("success")) {
                                ...
                                Intent intent = new Intent(PermanentDonatorActivity.this, HomeActivity.class);
                                Toast.makeText(PermanentDonatorActivity.this, " Registration Successful!", Toast.LENGTH_SHORT).show();
                                ...
                                loading.dismiss();
                                Toast.makeText(PermanentDonatorActivity.this, " Registration Fail!", Toast.LENGTH_SHORT).show();

                            } else {

                                loading.dismiss();
                                Toast.makeText(PermanentDonatorActivity.this, "Email or Contact No Already Exist!!", Toast.LENGTH_SHORT).show();
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(PermanentDonatorActivity.this, "No Internet Connection !!!", Toast.LENGTH_SHORT).show();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(PermanentDonatorActivity.this);
