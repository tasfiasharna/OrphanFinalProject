...
public class VolunteerRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnChooseImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dexter.withActivity(VolunteerRegistrationActivity.this)
        ...
        btn_registration.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(VolunteerRegistrationActivity.this);
    ...
    private void setDate(final EditText date_Input) {
        final DatePicker datePicker = new DatePicker(VolunteerRegistrationActivity.this);
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(VolunteerRegistrationActivity.this, theme, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    private void dataRequest(final String name, final String address, final String email,final String profession, final String date, final String phone, final String reason,final String gender,final String listen,final String blood) {
        ...
        if(name.isEmpty()){
            ...
            StringRequest request = new StringRequest(Request.Method.POST, "http://192.168.0.105:8080/api/volunteer/user/registration",
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.equals("Registration Successful")) {
                                ...
                                Intent intent = new Intent(VolunteerRegistrationActivity.this, UserActivity.class);
                                ...
                                loading.dismiss();
                                Toast.makeText(VolunteerRegistrationActivity.this, " Registration Fail!", Toast.LENGTH_SHORT).show();

                            } else {

                                loading.dismiss();
                                Toast.makeText(VolunteerRegistrationActivity.this, "Network Error", Toast.LENGTH_SHORT).show();
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            Toast.makeText(VolunteerRegistrationActivity.this, "No Internet Connection !!!", Toast.LENGTH_SHORT).show();
            ...
            RequestQueue requestQueue = Volley.newRequestQueue(VolunteerRegistrationActivity.this);
    ...
    public void onBackPressed() {
        if (back_pressed+TIME_DELAY > System.currentTimeMillis()) {
            ...
            Intent intent = new Intent(VolunteerRegistrationActivity.this, HomeActivity.class);
    ...
    public void moveToLogin(View view) {
        ...
        startActivity(new Intent(getApplicationContext(), VolunteerLogInActivity.class));
        finish();
